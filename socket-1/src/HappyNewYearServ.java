...
public class HappyNewYearServ {
    ...
    public static void main(String arg[]) {
        try {
            ...
            HappyNewYearPresent present = (HappyNewYearPresent) ois.readObject();// Integerクラスでキャスト。
            ...
            HappyNewYearPresent response = new HappyNewYearPresent();
            response.setMessage("サーバーです。あけおめ！\n" + presentFromClient + "円ありがとう。\n");
